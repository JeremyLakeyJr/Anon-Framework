class Menu:
    ...
    def handle_server_menu(self, choice):
        ...
        if choice == "1":
            ...
            self.client.switch_server(new_server, new_port)
        elif choice == "2":
            self.client.disconnect()
        elif choice == "3":
            self.current_menu = "main"
    ...
    def nickname_menu(self):
        ...
        print("\n--- Nickname Menu ---")
        print(f"Current Nickname: {self.client.nickname}")
    ...
    def handle_identity_menu(self, choice):
        ...
        if choice == "1":
            ...
            self.client.save_identity(identity_name)
        elif choice == "2":
            self.client.load_identity()
        elif choice == "3":
            self.current_menu = "main"
        else:
            print("Invalid choice.")
